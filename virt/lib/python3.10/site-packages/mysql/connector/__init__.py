...
from .constants import FieldFlag, FieldType, CharacterSet, RefreshOption, ClientFlag
from .dbapi import (
    Date,
    Time,
    Timestamp,
...
def _get_pooled_connection(**kwargs):
    ...
    from .pooling import MySQLConnectionPool, generate_pool_name, CONNECTION_POOL_LOCK
    ...
    if "fabric" in kwargs:
        if "pool_name" in kwargs:
            raise AttributeError(
                "'pool_name' argument is not supported with "
