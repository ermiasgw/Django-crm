...
class DatabaseCreation(BaseDatabaseCreation):
    ...
    def sql_for_inline_many_to_many_references(self, model, field, style):
        ...
        table_output = [
            ...
            columndef.format(
                ...
                type=style.SQL_COLTYPE(
                    models.ForeignKey(field.rel.to).db_type(connection=self.connection)
                ),
                options=style.SQL_KEYWORD("NOT NULL"),
            ),
        ]
    ...
    def sql_destroy_indexes_for_fields(self, model, fields, style):
        ...
        index_name = "{0}_{1}".format(
            model._meta.db_table, self._digest([f.name for f in fields])
        )
        ...
        return [
            ...
            + " "
            + style.SQL_TABLE(
                qn(truncate_name(index_name, self.connection.ops.max_name_length()))
            )
            + " "
