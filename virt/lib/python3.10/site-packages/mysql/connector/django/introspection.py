...
class DatabaseIntrospection(BaseDatabaseIntrospection):
    ...
    if django.VERSION >= (1, 8):
        ...
        def get_table_description(self, cursor, table_name):
            ...
            InfoLine = namedtuple(
                "InfoLine", "col_name data_type max_len num_prec num_scale extra"
            )
            cursor.execute(
                """
        ...
        def get_table_description(self, cursor, table_name):
            ...
            numeric_map = dict(
                (line[0], tuple([int(n) for n in line[1:]]))
    ...
    def get_indexes(self, cursor, table_name):
        cursor.execute(
            "SHOW INDEX FROM {0}" "".format(self.connection.ops.quote_name(table_name))
        )
