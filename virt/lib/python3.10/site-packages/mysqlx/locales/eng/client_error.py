...
CR_CONNECTION_ERROR = (
    u"Can't connect to local MySQL server through socket '%-.100s' (%s)"
)
...
CR_NAMEDPIPESETSTATE_ERROR = (
    u"Can't set state of named pipe to host: %-.64s  pipe: %-.32s (%s)"
)
...
CR_INVALID_BUFFER_USE = (
    u"Can't send long data for non-string/non-binary data types (parameter: %s)"
)
...
CR_SHARED_MEMORY_CONNECT_REQUEST_ERROR = (
    u"Can't open shared memory; client could not create request event (%s)"
)
CR_SHARED_MEMORY_CONNECT_ANSWER_ERROR = (
    u"Can't open shared memory; no answer event received from server (%s)"
)
CR_SHARED_MEMORY_CONNECT_FILE_MAP_ERROR = (
    u"Can't open shared memory; server could not allocate file mapping (%s)"
)
CR_SHARED_MEMORY_CONNECT_MAP_ERROR = (
    u"Can't open shared memory; server could not get pointer to file mapping (%s)"
)
CR_SHARED_MEMORY_FILE_MAP_ERROR = (
    u"Can't open shared memory; client could not allocate file mapping (%s)"
)
CR_SHARED_MEMORY_MAP_ERROR = (
    u"Can't open shared memory; client could not get pointer to file mapping (%s)"
)
CR_SHARED_MEMORY_EVENT_ERROR = (
    u"Can't open shared memory; client could not create %s event (%s)"
)
CR_SHARED_MEMORY_CONNECT_ABANDONED_ERROR = (
    u"Can't open shared memory; no answer from server (%s)"
)
CR_SHARED_MEMORY_CONNECT_SET_ERROR = (
    u"Can't open shared memory; cannot send request event to server (%s)"
)
...
CR_NO_RESULT_SET = (
    u"Attempt to read a row while there is no result set associated with the statement"
)
...
CR_ALREADY_CONNECTED = (
    u"This handle is already connected. Use a separate handle for each connection."
)
