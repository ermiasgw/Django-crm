...
_STMTEXECUTE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="namespace",
            full_name="Mysqlx.Sql.StmtExecute.namespace",
            index=0,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="stmt",
            full_name="Mysqlx.Sql.StmtExecute.stmt",
            index=1,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="args",
            full_name="Mysqlx.Sql.StmtExecute.args",
            index=2,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Sql.StmtExecute.compact_metadata",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
...
StmtExecute = _reflection.GeneratedProtocolMessageType(
    "StmtExecute",
    (_message.Message,),
    dict(
...
StmtExecuteOk = _reflection.GeneratedProtocolMessageType(
    "StmtExecuteOk",
    (_message.Message,),
    dict(
