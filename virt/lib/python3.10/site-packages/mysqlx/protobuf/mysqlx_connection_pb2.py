...
_CAPABILITY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="name",
            full_name="Mysqlx.Connection.Capability.name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="Mysqlx.Connection.Capability.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_CAPABILITIES = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="capabilities",
            full_name="Mysqlx.Connection.Capabilities.capabilities",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CAPABILITIESSET = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="capabilities",
            full_name="Mysqlx.Connection.CapabilitiesSet.capabilities",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
CapabilitiesGet = _reflection.GeneratedProtocolMessageType(
    "CapabilitiesGet",
    (_message.Message,),
    dict(
...
CapabilitiesSet = _reflection.GeneratedProtocolMessageType(
    "CapabilitiesSet",
    (_message.Message,),
    dict(
