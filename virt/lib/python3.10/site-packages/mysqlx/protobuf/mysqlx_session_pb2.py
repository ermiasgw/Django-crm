...
_AUTHENTICATESTART = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="mech_name",
            full_name="Mysqlx.Session.AuthenticateStart.mech_name",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="auth_data",
            full_name="Mysqlx.Session.AuthenticateStart.auth_data",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Session.AuthenticateStart.initial_response",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
_AUTHENTICATECONTINUE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="auth_data",
            full_name="Mysqlx.Session.AuthenticateContinue.auth_data",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
_AUTHENTICATEOK = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="auth_data",
            full_name="Mysqlx.Session.AuthenticateOk.auth_data",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
...
AuthenticateStart = _reflection.GeneratedProtocolMessageType(
    "AuthenticateStart",
    (_message.Message,),
    dict(
...
AuthenticateContinue = _reflection.GeneratedProtocolMessageType(
...
AuthenticateOk = _reflection.GeneratedProtocolMessageType(
    "AuthenticateOk",
    (_message.Message,),
    dict(
