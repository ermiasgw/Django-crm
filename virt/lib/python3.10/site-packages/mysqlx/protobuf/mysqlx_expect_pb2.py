...
_OPEN_CONDITION_CONDITIONOPERATION = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="EXPECT_OP_SET", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EXPECT_OP_UNSET", index=1, number=1, options=None, type=None
        ),
    ],
...
_OPEN_CTXOPERATION = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="EXPECT_CTX_COPY_PREV", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="EXPECT_CTX_EMPTY", index=1, number=1, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_OPEN_CONDITION = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="condition_key",
            full_name="Mysqlx.Expect.Open.Condition.condition_key",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="Mysqlx.Expect.Open.Condition.condition_value",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="op",
            full_name="Mysqlx.Expect.Open.Condition.op",
            index=2,
            number=3,
            type=14,
            cpp_type=8,
...
_OPEN = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="op",
            full_name="Mysqlx.Expect.Open.op",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="cond",
            full_name="Mysqlx.Expect.Open.cond",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
Open = _reflection.GeneratedProtocolMessageType(
    "Open",
    (_message.Message,),
    dict(
