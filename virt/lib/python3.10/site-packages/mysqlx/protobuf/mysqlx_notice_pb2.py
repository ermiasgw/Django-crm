...
_FRAME_SCOPE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="GLOBAL", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="LOCAL", index=2, number=2, options=None, type=None
        ),
    ],
...
_WARNING_LEVEL = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="NOTE", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_SESSIONSTATECHANGED_PARAMETER = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="CURRENT_SCHEMA", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ACCOUNT_EXPIRED", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="GENERATED_INSERT_ID", index=3, number=3, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ROWS_AFFECTED", index=4, number=4, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ROWS_FOUND", index=5, number=5, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ROWS_MATCHED", index=6, number=6, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TRX_COMMITTED", index=7, number=7, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="TRX_ROLLEDBACK", index=8, number=9, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="PRODUCED_MESSAGE", index=9, number=10, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="CLIENT_ID_ASSIGNED", index=10, number=11, options=None, type=None
        ),
    ],
    containing_type=None,
    options=None,
...
_FRAME = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="payload",
            full_name="Mysqlx.Notice.Frame.payload",
            index=2,
            number=3,
            type=12,
            cpp_type=9,
...
_WARNING = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="code",
            full_name="Mysqlx.Notice.Warning.code",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="msg",
            full_name="Mysqlx.Notice.Warning.msg",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_SESSIONVARIABLECHANGED = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="param",
            full_name="Mysqlx.Notice.SessionVariableChanged.param",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="Mysqlx.Notice.SessionVariableChanged.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SESSIONSTATECHANGED = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="param",
            full_name="Mysqlx.Notice.SessionStateChanged.param",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="value",
            full_name="Mysqlx.Notice.SessionStateChanged.value",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_SESSIONVARIABLECHANGED.fields_by_name[
    "value"
].message_type = mysqlx__datatypes__pb2._SCALAR
_SESSIONSTATECHANGED.fields_by_name["param"].enum_type = _SESSIONSTATECHANGED_PARAMETER
_SESSIONSTATECHANGED.fields_by_name[
    "value"
].message_type = mysqlx__datatypes__pb2._SCALAR
...
SessionVariableChanged = _reflection.GeneratedProtocolMessageType(
...
SessionStateChanged = _reflection.GeneratedProtocolMessageType(
    "SessionStateChanged",
    (_message.Message,),
    dict(
